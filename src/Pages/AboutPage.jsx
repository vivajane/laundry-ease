...
const AboutPage = () => {
  return (
    <div>
      ...
      <div className="md:flex md:px-24 px-6 gap-24 pt-10 my-10">
        <img src={machine} alt="machine" />
        <div className="py-8 md:py-1">
          <h2 className="font-merriweather font-bold text-2xl">About Us</h2>
          <p className="md:py-4 font-poppins text-base font-[200px] md:font-[400px]">
      ...
      <div className="md:px-24 px-6 md:flex gap-24 py-20 my-10 bg-customers">
        <div className="">
        ...
        <img data-aos="slide-up"
          ...
          data-aos-duration="600"  className="mb-12 h-contain w-[100%] md:w-[50%]" src={hanger} alt="hanger" />
      </div>

      <div className="md:px-24 px-6 md:flex gap-24 pt-10 my-10 justify-between items-start">
        <img data-aos="slide-left"
          data-aos-delay="200"
          data-aos-easing="ease-in-sine"
          data-aos-duration="600" className="md:w-[50%] w-[100%]" src={threemen} alt="men" />
        <div data-aos="slide-up"
          data-aos-delay="200"
          data-aos-easing="ease-in-sine"
          data-aos-duration="600" className=" py-6 md:py-1 font-poppins text-base font-[500px]">
      ...
      <div data-aos="slide-right"
          data-aos-delay="200"
          data-aos-easing="ease-in-sine"
          data-aos-duration="600" className="md:px-24 px-6 md:grid md:my-0 grid-cols-3 gap-3 bg-customers py-14">
        <div className="bg-[#FFFFFF] px-6 py-4 md:my-0 my-2">
          <div className="flex gap-4 items-center ">
            <img className="h-4" src={vision} alt="vision" />
            <h3 className="text-bluey font-bold text-base font-merriweather">
              Our Mission
            </h3>
          </div>
          <p className="pt-3 font-poppins text-[14px] font-[400px]">
            Our mission at LaundryEase is to revolutionize the laundry
            experience by making it as convenient and efficient as possible. We
            aim to provide top-notch laundry services that cater to the diverse
            needs of our customers, all while supporting local laundromats and
            promoting eco-friendly practices.
          </p>
        </div>
        <div className="bg-[#FFFFFF] px-4 py-4 md:my-0 my-2">
          <div className="flex gap-4 items-center pb-2 ">
            <img className="h-4" src={empower} alt="empower" />
            <h3 className="text-bluey font-bold text-base font-merriweather">
              Our Empowering Local businesses
            </h3>
          </div>
          <p className="pt-2 font-poppins text-[14px] font-[400px]">
            We believe in the power of community and the importance of
            supporting local businesses. By partnering with local laundromats,
            LaundryEase helps these businesses expand their customer base,
            streamline their operations, and increase their revenue.
          </p>
        </div>
        <div className="bg-[#FFFFFF] px-6 py-4 md:my-0 my-2">
          <div className="flex gap-4 items-center">
          ...
          <p className="pt-4 font-poppins text-[14px] font-[400px] ">
            LaundryEase is committed to delivering exceptional service and
            ensuring customer satisfaction. We continuously strive to improve
            our platform and services based on user feedback and emerging trends
