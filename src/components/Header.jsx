...
const Header = () => {
  ...
  return (
    <div
      className={`h-screen w-full fixed z-10 top-0 left-0 ${
      ...
      <div className="bg-gradient-to-r from-[#184892] via-[#2061C5] to-[#287AF8]">
        ...
        >
          ...
          <ul className="md:flex hidden flex-1 gap-16 pl-10 text-[#FFFFFF]">
            <NavLink
              to="/"
              className="hover:text-txtblue hover:underline hover:text-xl"
            >
              Home
            </NavLink>
            <NavLink
          ...
          <NavLink
            to="downlaodapp"
            className="md:block hidden text-blue bg-white px-4 py-2 rounded-lg"
          >
            Download App
          </NavLink>
          <ul
          ...
          >
            ...
            <NavLink to="aboutpage" className="py-4">
              About Us
            </NavLink>
            <NavLink to="services" className="py-4">
              Our Services
            </NavLink>
            <NavLink to="blog" className="py-4">
              Blog
            </NavLink>
            <NavLink to="contact" className="py-4">
              Contact Us
            </NavLink>
            <NavLink to="downlaodapp" className="py-4">
              Download App
            </NavLink>
          </ul>
        </div>
